...
void GameEngine::TransformComponent::setLocalRotation(GameMath::Vector3 rotationX)
{
...
void GameEngine::TransformComponent::updateMatrices()
{
    ...
    GameMath::Matrix4 rotationY = GameMath::Matrix4::createRotationX(m_rotation.y);
    GameMath::Matrix4 rotationZ = GameMath::Matrix4::createRotationX(m_rotation.z);
